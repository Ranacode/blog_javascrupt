...
var categories = (0, _jquery2.default)('.right-column').find('.categories');

categories.on('mouseover', 'a.link-category', function () {
  (0, _jquery2.default)(this).children().css('color', '#FFF');
});
categories.on('mouseleave', 'a.link-category', function () {

  (0, _jquery2.default)(this).children().css('color', '#000');
});
